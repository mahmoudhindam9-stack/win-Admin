            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400 font-medium">
                      {metrics.ramTotalGB.toFixed(1)} GB Physical RAM
                    </p>
                  </div>
                </div>
                <div className="text-right">
              ...
              <div className="space-y-3 mb-8 text-xs font-medium">
                <div className="flex justify-between items-center border-b border-slate-800/50 pb-2">
                  ...
                  <span className="text-slate-200 font-mono">{metrics.ramUsedGB.toFixed(1)} GB</span>
                </div>
                <div className="flex justify-between items-center border-b border-slate-800/50 pb-2">
                ...
                <div className="flex justify-between items-center border-b border-slate-800/50 pb-2">
                  ...
                  <span className="text-slate-200 font-mono">{Math.max(0, metrics.ramTotalGB - metrics.ramUsedGB - metrics.ramStandbyGB).toFixed(1)} GB</span>
                </div>
              </div>
            </div>
